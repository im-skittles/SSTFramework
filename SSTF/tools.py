...
def WhatIsSSTF():
	print("SSTF or SkSweetToothFramework is a framework built by Skittles_.\nIt includes a port scanner, Server (Not Quite There Yet.), and other useful tools for hackin' stuff. ")
